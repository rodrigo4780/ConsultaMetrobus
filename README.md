...
```
.net Core 3.1  (Consulta de datos y servicio).
Base de datos Postgresql
```

## Versionado

_Se ocupo GitHub para el versionado del proyecto._
...
_por el obtenido en la inspección en los comandos siguientes donde aparezca el host._
...
_Se implementa el API que permite consultar la información almacenada_
